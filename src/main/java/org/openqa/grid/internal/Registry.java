...
// assignRequestToProxy is reached. No before.
    ...
    /**
     * How long a session can remain in the newSession queue before being
     * evicted.
     *     
...
* @param proxy The proxy to add
     ...
     *     
* @param throwOnCapabilityNotPresent true to throw if capability not
     * present
     */
...
* @param externalKey the external session key
    ...
    private void logReason(SessionTerminationReason reason) {
        new CustomTerminationLogger().recordNew(reason.toString());
    }
