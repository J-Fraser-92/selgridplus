...
public class RemoteVideoRecorderHelper {
    ...
    public static String startVideoRecording(String host, String session) {
        ...
        URI uri;
        String errorMessage = String.format("StartVideoRecording - Error building URI for host: %s, port: %s, session: %s, action: %s, params: %s",
                host,
    ...
    public static String stopVideoRecording(String host, String session) {
        ...
        URI uri;
        String errorMessage = String.format("StopVideoRecording - Error building URI for host: %s, port: %s, session: %s, action: %s, params: %s",
                host,
                RuntimeConfig.getGridExtrasPort(),
                session,
    ...
    public static String updateLastAction(String host, String session, String action) {
        ...
        URI uri;
        String errorMessage = String.format("UpdateLastAction - Error building URI for host: %s, port: %s, session: %s, action: %s, params: %s",
                host,
                RuntimeConfig.getGridExtrasPort(),
                session,
