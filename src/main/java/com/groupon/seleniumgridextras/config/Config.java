...
public class Config {
    ...
    public static final String PUBLIC_SCREENSHOTS = "expose_directory";
    public static final String PRIVATE_SCREENSHOTS = "screenshots_directory";
    ...
    public static final String UNWANTED_PROCESSES = "unwanted_processes";
    ...
    public List<String> getUnwantedProcesses() {
        return (List<String>) getConfigMap().get(UNWANTED_PROCESSES);
    }
    ...
    public String getPublicScreenshotsDir() {
        return (String) getConfigMap().get(PUBLIC_SCREENSHOTS);
    }
    
    public String getPrivateScreenshotsDir() {
        return (String) getConfigMap().get(PRIVATE_SCREENSHOTS);
    }
    ...
    public void setPrivateDir(String sharedDir) {
        getConfigMap().put(PRIVATE_SCREENSHOTS, sharedDir);
    }

    public void setPublicDir(String sharedDir) {
        getConfigMap().put(PUBLIC_SCREENSHOTS, sharedDir);
    }
