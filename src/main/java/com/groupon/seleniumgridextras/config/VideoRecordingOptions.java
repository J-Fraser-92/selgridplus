...
public class VideoRecordingOptions extends HashMap<String, String> {
    ...
    private static final String PUBLIC_VIDEOS = "video_output_dir";
    private static final String PRIVATE_VIDEOS = "video_storage_dir";
    ...
    public void setPrivateDir(String outputDir) {
        this.put(PRIVATE_VIDEOS, outputDir);
    }

    public void setPublicDir(String outputDir) {
        this.put(PUBLIC_VIDEOS, outputDir);
    }

    public File getPrivateDir() {
        return new File(this.get(PRIVATE_VIDEOS));
    }

    public String getPrivateDirPath() {
        return this.get(PRIVATE_VIDEOS);
    }

    public File getPublicDir() {
        return new File(this.get(PUBLIC_VIDEOS));
    }
