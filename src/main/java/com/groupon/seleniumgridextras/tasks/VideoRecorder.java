...
public class VideoRecorder extends ExecuteOSTask {
    ...
    public File videoOutputDir = RuntimeConfig.getConfig().getVideoRecording().getPrivateDir();
...
/*
        ...
        try {
            for (File f : RuntimeConfig.getConfig().getVideoRecording().getPublicDir().listFiles()) {
    ...
    protected String buildUrlToVideo(String fileName) {
        try {
            ...
            uriBuilder.setHost(NodeInformation.GetIpAddress());
