...
public class JsonCodec {
    ...
    public static class WebDriver {
        ...
        public static class Grid {
            ...
            public static final String FORCE_REBOOT = "force_reboot";
        ...
        public static class JSON {
            ...
            public static final String BROWSER_ACTIVE = "browser_active";
            public static final String BUSY = "busy";
            public static final String CONFIGS_COPIED = "configs_copied";
            public static final String CONFIGS_UPDATED = "configs_updated";
            public static final String CONFIGS_NOT_UPDATED = "configs_updated_not_updated";
            public static final String CONFIGS_NOT_UPDATED_LIST = "configs_updated_not_updated_list";
            public static final String CURRENTLY_BUSY = "currently_busy";
            public static final String DUE_REBOOT = "due_reboot";
            public static final String IDLE_TIME_SECONDS = "idle_time_seconds";
            public static final String IP_ADDRESS = "ip_address";
            public static final String MACHINE_NAME = "machine_name";
            public static final String MACHINES_UPDATED = "machines_updated";
            public static final String MACHINES_NOT_UPDATED = "machines_updated_not_updated";
            public static final String MACHINES_NOT_UPDATED_LIST = "machines_updated_not_updated_list";
            public static final String REBOOT_CONFIRMED = "reboot_confirmed";
            public static final String START_BAT_MODIFIED = "start_bat_modified";
            public static final String STATUS = "status";
            public static final String SUPPORTS_IE = "supports_ie";
            public static final String SUPPORTS_CHROME = "supports_chrome";
            public static final String SUPPORTS_FIREFOX = "supports_firefox";
            public static final String SUPPORTS_SAFARI = "supports_safari";
            public static final String TEST_DURATION_SECONDS = "test_duration_seconds";
            public static final String TEST_DURATION_STRING = "test_duration_string";
            public static final String TEST_LIMIT = "test_limit";
            public static final String TESTS_RAN = "tests_ran";
            public static final String UPTIME = "uptime";
            public static final String HUB_IP = "hub_ip";
        }
    }
}
