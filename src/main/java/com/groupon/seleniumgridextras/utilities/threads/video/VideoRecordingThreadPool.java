...
public class VideoRecordingThreadPool {
    ...
    protected static Map<String, VideoRecorderCallable> videos = new HashMap<String, VideoRecorderCallable>();
        ...
        try {
            ...
            for (String session : futures.keySet()) {
                ...
                if (f.isCancelled() || f.isDone()) {
                    logger.info("cancelled: " + f.isCancelled() + " done: " + f.isDone() + " - session " + session);
    ...
    public static void setRecordingFile(String filename) {
        recordingFile = filename;
    }
    
    public static void clearRecordingFile() {
        recordingFile = "";
    }
    
    public static String getRecordingFile() {
